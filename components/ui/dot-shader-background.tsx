...
const DotMaterial = shaderMaterial(
  ...
  /* glsl */ `
    ...
    void main() {
      ...
      // Basic tonemapping and colorspace handling manually if includes fail or to be safe
      // but usually these includes work in standard materials. 
      // For ShaderMaterial in r3f, raw shader usage implies fewer default chunks.
      // We'll trust the user provided code chunks.
...
function Scene() {
    ...
    useEffect(() => {
        dotMaterial.uniforms.dotColor.value.setHex(Number(themeColors.dotColor.replace('#', '0x')))
        dotMaterial.uniforms.bgColor.value.setHex(Number(themeColors.bgColor.replace('#', '0x')))
